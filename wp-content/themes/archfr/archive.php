...
<td><?php the_date('', '', ''); ?></td>
<td class="wrap"><a href="<?php the_permalink() ?>"
...
<br/>
	...
	<div class="nav-previous"><?php next_posts_link('&laquo; Anciens articles') ?></div>
	<div class="nav-next"><?php previous_posts_link('Articles suivants &raquo;') ?></div>
	</div>
